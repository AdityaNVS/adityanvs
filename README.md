...
I'm a passionate self taught **Front-end Developer** 🚀 from India, currently a **Junior Year Student** in **Computer Science** Stream from [@Gitam University](https://www.gitam.edu/) 🎓 and I work as Technical Intern at [@Hackerearth](https://wwww.hackerearth.com) and currently an Alpha Microsoft Learn Student Ambassador . Also worked in past as a Operations Lead 🙋‍♂️ at [@DSC GITAM](https://github.com/dsc-gitam) for couple of years and a Front-end Dev at [@GirlScript](https://github.com/girlscript)  Vizag Chapter for an year. 
